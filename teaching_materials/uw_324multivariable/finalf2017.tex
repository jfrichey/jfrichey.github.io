...
\begin{enumerate} \item \textbf{True}\hspace{5pt} \textbf{False} \hspace{5pt} If $S$ is any closed surface enclosing the origin, oriented towards the origin, then 

\[
\iint_S \frac{r}{|r|^2} \cdot dS = -4\pi,
\]
...
\item \textbf{True} \hspace{5pt} \textbf{False} \hspace{5pt} For any vector field $F$, 

\[
\nabla \Big(\nabla \cdot \Big(\nabla \times \nabla\Big( \nabla \cdot F\Big)\Big)\Big) = 0.
\]
...
\newpage
 ...
 \item (20 pts) Consider the radial vector field $F = \frac{1}{\rho^4} \vec{\rho}$, where $\vec{\rho} = \langle x, y, z \rangle$ and $\rho = |\vec{\rho}| = \sqrt{x^2+y^2+z^2}$.  

\begin{enumerate} \item (5 pts) Find the divergence of $F$ for $\rho > 0$, and write your final answer in terms of $\rho$. You may use the formula 

\[
\nabla \cdot G = \frac{1}{\rho^2} \frac{\partial }{\partial \rho} \Big( \rho^3 g(\rho) \Big)
\]

for radial vector fields $G = g(\rho) \vec{\rho}$. 
