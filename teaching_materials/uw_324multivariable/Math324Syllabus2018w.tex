...
\centerline{\bf Advanced Multivariable Calculus I: Math 324 D - Winter 2018}
\vspace{0.2cm}
\begin{tabular}{lllll}
...
Edition. Webassign is required for this course, and purchasing a webassign key 
(which you should already have from Math 124/5/6) comes with a copy of the e-book.
If you want a hard copy: we're using a custom edition of Stewart's Calculus,
...
Midterm 1  ({\bf Friday, January 26})                   & 25  \\
Midterm 2  ({\bf Friday, February 16})                   & 25   \\
Final Exam ({\bf Wednesday, March 14, 2:30-4:20 in CHL 015})                        & 35  \\
\hline Total                                        & 100
\end{tabular}
\end{center}
...
\noindent {\bf Lecture:}  Lecture is on Monday, Wednesday, and Friday, 11:30-12:20 in CHL 015.  You
are responsible for all information that is discussed
during lecture. 
\vspace{0.25cm}

\noindent {\bf Homework:}  Homework will be assigned weekly through webassign. You may need a scientific calculator for solving homework problems in Math 324.  It must have trigonometric functions, like Sin and Cos, as well as logarithms and exponentials (ln and exp).
\vspace{0.25cm}
