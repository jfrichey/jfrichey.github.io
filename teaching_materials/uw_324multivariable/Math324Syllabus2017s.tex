...
\centerline{\bf Advanced Multivariable Calculus I: Math 324 A - Summer 2017}
\vspace{0.2cm}
\begin{tabular}{lllll}
{\bf Lecturer: }    & Jacob Richey &  & {\bf Email: }       & jfrichey@math.washington.edu \\
{\bf Office: }      & Padelford C-8K        &  & {\bf Web page: }    & www.math.washington.edu/$\sim$jfrichey/teaching.html \\
\end{tabular}
\vspace{0.25cm}

\noindent {\bf Office Hours: TBA.}  
If you can't make my office hours, e-mail me and we can set up another time to meet.  \vspace{0.25cm}
...
Volume 1 covers Math 124/125, Volume 2 covers Math 126/324. Note: a hard copy of the text
is NOT required for the course. You will need webassign access for homework, which comes with the e-book. 
...
Homework   ({\bf Due weekly})                 & 10  \\
Midterm 1  ({\bf Friday, July 7})                   & 30  \\
Midterm 2  ({\bf Friday, July 28})                   & 30   \\
Final Exam ({\bf Friday, August 18, in WFS 201.})                        & 30  \\
\hline Total                                        & 100
\end{tabular}
\end{center}
...
\noindent {\bf Lecture:}  Lecture is on Monday, Wednesday, and Friday, 9:40-10:40 AM in WFS 201.  You
are responsible for all information that is discussed
during lecture.
\vspace{0.25cm}

\noindent {\bf Homework:}  Homework will be assigned weekly through webassign, and will (generally) be due each Friday. You may need a scientific calculator for solving homework problems in Math 324.  It must have trigonometric functions, like Sin and Cos, as well as logarithms and exponentials (ln and exp).
\vspace{0.25cm}


\noindent {\bf Exams:}  All exams will be 60 minutes long and
will be given at lecture.  The final exam is cumulative. During the exam you are allowed one 
sheet of hand-written notes (8.5x11 inches, double sided), but \emph{no calculator}.
...
found at: {\bf http://www.math.washington.edu/$\sim$jfrichey/teaching.html} \\ You
...
there, including past exams and quizzes, office hour announcements, etc.
